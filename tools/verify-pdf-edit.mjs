...
check(
  ...
  unwritable(line.writer, 'Zagreb 2026').length === 0,
  unwritable(line.writer, 'Zagreb 2026').join(' '),
);
...
check(
  ...
  unwritable(line.writer, 'Vodice čćžšđ').join('') === 'čćđ',
  unwritable(line.writer, 'Vodice čćžšđ').join(' '),
);
